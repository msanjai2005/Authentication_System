...
export const Home = () => {
  ...
  return (
    <div>
      <Homebar/>
      <div className="w-screen min-h-screen bg-stone-100 flex justify-center items-center">
        <div className="p-4 flex flex-col justify-center items-center gap-2 ">
          <h1 className="text-4xl font-semibold text-gray-700 text-center">
            Welcome to {" "}
            <span className="font-bold text-blue-500">Secure Login!</span> System
          </h1>
          <h3 className="text-xl font-medium text-gray-500">
            High security with JWT
          </h3>
          <button
    ...
    <div className="w-full bg-[#F9FAFB]">
      <header className="w-full fixed top-0 left-0 bg-white backdrop-blur-md shadow-sm border-b border-gray-200 z-100">
        <div className="w-full px-2 sm:px-30 h-[70px] flex justify-between items-center">
          ...
          <Button name="Login" width="w-25" onClick={()=>{navigate('/login')}}/>
        </div>
      </header>
    </div>
  );
